...
public class ManaCapAttacher {
    private static class ManaCapProvider implements ICapabilityProvider, INBTSerializable<CompoundTag> {
        ...
        public static final ResourceLocation IDENTIFIER = new ResourceLocation(Druidry.MODID, "mana");
        ...
        public <T> LazyOptional<T> getCapability(@NotNull Capability<T> cap, @Nullable Direction side) {
            return Capabilities.MANA_CAPABILITY.orEmpty(cap, this.optionalData);
        }
